...
# PLSC 502 -- Fall 2022
#
# Day Fifteen materials: Bayesian Statistics and
#                        Missing Data...
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
# Packages, etc.:

P<-c("readr","psych","plyr","htmltab","car","mvtnorm",
     "DescTools","rstan","rstanarm","brms","texreg")
...
#
# (UHsing a beta distribution just for the pictures;
