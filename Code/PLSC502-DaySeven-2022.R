...
# Load a package or two (you'll probably need to install one or more of
# these, using install.packages()...):
...
#
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
# Make a nice figure for the margin of error for a binary proportion,
...
WB<-read_csv("https://raw.githubusercontent.com/PrisonRodeo/PLSC502-2022-git/master/Data/WarrenBurger.csv")
