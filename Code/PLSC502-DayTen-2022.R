...
# 
# Africa<-read_csv("https://raw.githubusercontent.com/PrisonRodeo/PLSC502-2022-git/master/Data/africa2001.csv")
# 
# # Summary:
# 
...
T<-AgeDiff / sqrt((vM/2690)+(vF/427))
T

# Now using t.test:

T0<-t.test(AppAge~Gender,data=Js)
T0
